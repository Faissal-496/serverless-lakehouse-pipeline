...
class SparkJob(ABC):
    ...
    def execute(self) -> bool:
        ...
        try:
            with JobMetricsContext(self.JOB_NAME):  # noqa: F841
    ...
    def _initialize_spark(self) -> SparkSession:
        ...
        spark = SparkFactory.create_session(app_name=self.JOB_NAME, config=self.config)
    ...
    def _handle_error(self, error: Exception):
        ...
        """
        logger.error(f"Error handling for {self.JOB_NAME}", error_type=type(error).__name__)
